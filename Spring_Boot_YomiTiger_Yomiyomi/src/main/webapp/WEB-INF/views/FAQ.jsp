  			...
  			<div class="col-md-3">
   			...
   			<br><br><br>
				...
				<div class="accordion" id="accordionExample">
				  ...
				  <div class="accordion-item">
				    <h2 class="accordion-header" id="headingOne">
				      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-collapseOne" aria-expanded="true" aria-controls="collapse-collapseOne">
						질문 1번
				      </button>
				    </h2>
