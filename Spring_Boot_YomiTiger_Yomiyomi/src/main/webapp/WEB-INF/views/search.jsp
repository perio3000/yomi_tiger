					...
					<div id="carouselExampleIndicators" class="carousel slide"
						...
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img
									src="https://contents.kyobobook.co.kr/display/i_1200_150%20(5)_c7eec86864f542e19dcedfd40577ffbb.jpg"
									class="d-block w-100" alt="...">
							</div>
							<div class="carousel-item">
								<img
									src="https://contents.kyobobook.co.kr/display/i_1200_150_5c223d82931447098c9b9fba98231cd9_58fba04b7de14d8d995dc613edc019ea.jpg"
									class="d-block w-100" alt="...">
							</div>
							<div class="carousel-item">
								<img
									src="https://contents.kyobobook.co.kr/display/i_1200_150_4c8ef027e8074ae78358e2b1ee9e5138.jpg"
									class="d-block w-100" alt="...">
							</div>
							<div class="carousel-item">
								<img
									src="https://contents.kyobobook.co.kr/display/bnM_i06_3f3c072dc9424637af5e3203d65d966b.jpg"
									class="d-block w-100" alt="...">
							</div>
						</div>
				...
				<div class="search-view">
					...
					<div class="view-mid-head">
						...
						<div class="search-item">
							<div class="dropdown">
								<button class="btn btn-secondary dropdown-toggle label"
						...
						<table class="search-total-table s-active">
							<tr>
								...
								<td style="width: 15%"><img
									src="https://contents.kyobobook.co.kr/pdt/9791136736697.jpg"
									alt="검색한 책"></td>
								<td style="width: 60%; padding-left: 10px;">
									<p class="bookname">[국내도서] 주술회전 19권</p>
									<p class="bookauthor">Gege Akutami</p>
									<p class="publisher">
										서울 미디어 코믹스 (서울문화사) <span>&#183;</span> <span>2022년 06월
											01일</span>
									</p>
									<div class="bookprice">
										<p>
											<span class="discount-price">5,400</span>원
										</p>
										<p>
										...
										<p>
											<span class="points-earned">300</span>p (<span>5</span>%)
										</p>
									</div>
								</td>
						...
						<table class="domestic-books-table">
							<tr>
								<td style="width: 10%; text-align: center" class="checkbox"><input
									type="checkbox" name="check" value="check"></td>
								<td style="width: 15%"><img
									src="https://contents.kyobobook.co.kr/pdt/9791136791788.jpg"
									alt="검색한 책"></td>
								<td style="width: 60%; padding-left: 10px;">
									<p class="bookname">[국내도서] 주술회전 19권</p>
									<p class="bookauthor">Gege Akutami</p>
						...
						<table class="overseas-books-table">
							<tr>
								<td style="width: 10%; text-align: center" class="checkbox"><input
									type="checkbox" name="check" value="check"></td>
								<td style="width: 15%"><img
									src="https://contents.kyobobook.co.kr/sih/fit-in/458x0/pdt/9791134889708.jpg"
									alt="검색한 책"></td>
								<td style="width: 60%; padding-left: 10px;">
									<p class="bookname">[국내도서] 체인소맨 11권</p>
									<p class="bookauthor">작가</p>
									<p class="publisher">
										서울 미디어 코믹스 (서울문화사) <span>&#183;</span> <span>2022년 06월
											01일</span>
									</p>
