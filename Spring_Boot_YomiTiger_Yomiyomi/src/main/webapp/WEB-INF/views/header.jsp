	...
	<nav class="navbar-head navbar-expand-lg navbar_head">
		...
		<div class="menuBody">
			<div class="row">
				...
				<div class="col">
					<ul>
						<li><a href="/notice/customercenter" class="fs-5 fw-bolder">고객센터&nbsp;<img src="/icon/right-arrow.png" width="16px" height="16px"></a></li>
						<li><a href="/notice/FAQ">자주 묻는 질문</a></li>
						<li><a href="/notice/qna">1:1 문의</a></li>
						<li><a href="/notice/events">이벤트</a></li>
						<li><a href="/notice/location">오프라인 매장</a></li>
