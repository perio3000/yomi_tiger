					...
					<tbody>
						...
						<tr class="cart-list-detail">
							...
							<td class="cart-img"><img
								...
								alt="주술회전"></td>
							<td>
								<p class="bookname">[일본도서] 주술회전 11권</p> <span class="price"><span class="priceBasic1">5,000</span>원</span>
							</td>
							<td class="cart-style"><span class="price"><span class="priceTotal1">5,000</span>원</span><br>
								<div class="updown">
						...
						<tr class="cart-list-detail">
							...
							<td class="cart-img"><img
								...
								alt="원피스"></td>
							<td>
								<p class="bookname">[해외도서] 원피스 95권</p><span class="price"><span class="priceBasic2">50,000</span>원</span>
							</td>
							<td class="cart-style"><span class="price"><span class="priceTotal2">50,000</span>원</span><br>
								<div class="updown">
									<span onclick="fnCalCount('m',this)"><i
										class="fa-solid fa-minus"></i></span> <input type="text"
										name="p_num1" id="p_num1" size="2" maxlength="4" class="p_num"
