						...
						<td class="cart-style"><span class="price">5000원</span><br>
							<div class="updown">
								<span onclick="fnCalCount('m',this)"><i
									class="fa-solid fa-minus"></i></span> <input type="text" name="p_num1"
									id="p_num1" size="2" maxlength="4" class="p_num" value="1">
								<span onclick="fnCalCount('p',this)"><i
			...
			<div class="accordion-item">
				<h2 class="accordion-header" id="headingOne">
					<button class="accordion-button" type="button"
						...
						aria-expanded="true" aria-controls="collapseOne">장바구니
						유의사항</button>
				</h2>
